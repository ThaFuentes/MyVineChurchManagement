...
# Full path: MyVineChurch/app/routes/prophecies.py
# File name: prophecies.py
# Brief, detailed purpose: Complete, clean blueprint for Prophecies module.
# Single URL /prophecies for listing (public for guests, all for logged-in).
# Full support for public/private/personal visibility.
# Submit / edit / delete + comment system with censorship and audit logging.
# All templates and routes now match your existing prophecies.html exactly.
