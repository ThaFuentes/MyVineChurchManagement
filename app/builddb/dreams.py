...
# The only updates are: much clearer comments, better code organization, and explicit documentation around the created_by column (this powers "Created by: [Name]" on the public dreams page, just like events, announcements, prayers, and sermons).
