...
# • Created for full modularity and consistency with events/forms.py (even though original announcements used inline validation).
...
print("✅ MYVINECHURCH.ONLINE public/announcements/forms.py loaded successfully")