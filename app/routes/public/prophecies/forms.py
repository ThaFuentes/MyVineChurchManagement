# MYVINECHURCH.ONLINE/app/routes/public/prophecies/forms.py
...
# • Created for full modularity and consistency with dreams/forms.py, announcements/forms.py and prayers/forms.py.
...
def validate_guest_comment_form(form_data):
    """Validate and clean the public guest comment / reply form used on prophecies."""
...
print("✅ MYVINECHURCH.ONLINE public/prophecies/forms.py loaded successfully")